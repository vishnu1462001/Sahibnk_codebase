...
.method public constructor <init>(Lorg/bouncycastle/crypto/tls/TlsContext;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/Chacha20Poly1305;->encryptIV:[B
    ...
    invoke-virtual {p1, v1, v0}, Lorg/bouncycastle/crypto/engines/ChaCha7539Engine;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method protected generateRecordMACKey(Lorg/bouncycastle/crypto/StreamCipher;)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-direct {p1, v0, v2, v1}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
...
.method protected updateRecordMACLength(Lorg/bouncycastle/crypto/Mac;I)V
    ...
    invoke-interface {p1, p2, v0, v1}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
