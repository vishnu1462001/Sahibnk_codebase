...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/bouncycastle/est/ESTClientProvider;)V
    ...
    const-string v0, "/.well-known/est/"
...
.method public getCACerts()Lorg/bouncycastle/est/CACertsResponse;
    ...
    iget-object v7, p0, Lorg/bouncycastle/est/ESTService;->server:Ljava/lang/String;
    ...
    iget-object v6, p0, Lorg/bouncycastle/est/ESTService;->clientProvider:Lorg/bouncycastle/est/ESTClientProvider;

    invoke-interface {v6}, Lorg/bouncycastle/est/ESTClientProvider;->makeClient()Lorg/bouncycastle/est/ESTClient;

    move-result-object v6

    new-instance v7, Lorg/bouncycastle/est/ESTRequestBuilder;

    const-string v8, "GET"

    invoke-direct {v7, v8, v5}, Lorg/bouncycastle/est/ESTRequestBuilder;-><init>(Ljava/lang/String;Ljava/net/URL;)V

    invoke-virtual {v7, v6}, Lorg/bouncycastle/est/ESTRequestBuilder;->withClient(Lorg/bouncycastle/est/ESTClient;)Lorg/bouncycastle/est/ESTRequestBuilder;

    move-result-object v7

    invoke-virtual {v7}, Lorg/bouncycastle/est/ESTRequestBuilder;->build()Lorg/bouncycastle/est/ESTRequest;

    move-result-object v11

    invoke-interface {v6, v11}, Lorg/bouncycastle/est/ESTClient;->doRequest(Lorg/bouncycastle/est/ESTRequest;)Lorg/bouncycastle/est/ESTResponse;
    ...
    invoke-virtual {v8, v0}, Lorg/bouncycastle/est/HttpUtil$Headers;->getFirstValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lorg/bouncycastle/est/HttpUtil$Headers;->getFirstValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lorg/bouncycastle/est/HttpUtil$Headers;->getFirstValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v4, v1, v3}, Lorg/bouncycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/cmc/SimplePKIResponse;->getCRLs()Lorg/bouncycastle/util/Store;
    ...
    invoke-interface {v1}, Lorg/bouncycastle/est/ESTClientProvider;->isTrusted()Z
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Lorg/bouncycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    :try_start_8
    invoke-virtual {v4}, Lorg/bouncycastle/est/ESTResponse;->close()V
    :try_end_8
...
.method public getCSRAttributes()Lorg/bouncycastle/est/CSRRequestResponse;
    ...
    invoke-interface {v2}, Lorg/bouncycastle/est/ESTClientProvider;->isTrusted()Z
    ...
    :try_start_1
    invoke-virtual {v4}, Lorg/bouncycastle/est/ESTResponse;->getStatusCode()I
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/est/ESTResponse;->getInputStream()Ljava/io/InputStream;
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v4}, Lorg/bouncycastle/est/ESTResponse;->getContentLength()Ljava/lang/Long;
    ...
    invoke-direct {v1, v5}, Lorg/bouncycastle/asn1/ASN1InputStream;-><init>(Ljava/io/InputStream;)V
    ...
    new-instance v5, Lorg/bouncycastle/est/CSRAttributesResponse;

    invoke-static {v1}, Lorg/bouncycastle/asn1/est/CsrAttrs;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/est/CsrAttrs;

    move-result-object v1

    invoke-direct {v5, v1}, Lorg/bouncycastle/est/CSRAttributesResponse;-><init>(Lorg/bouncycastle/asn1/est/CsrAttrs;)V
    :try_end_2
    ...
    invoke-direct {v1, v3, v0, v4, v2}, Lorg/bouncycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/est/ESTResponse;->getSource()Lorg/bouncycastle/est/Source;

    move-result-object v1

    invoke-direct {v0, v5, v1}, Lorg/bouncycastle/est/CSRRequestResponse;-><init>(Lorg/bouncycastle/est/CSRAttributesResponse;Lorg/bouncycastle/est/Source;)V
    ...
    invoke-direct {v2, v0, v1, v3, v5}, Lorg/bouncycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
...
.method public simpleEnroll(ZLorg/bouncycastle/pkcs/PKCS10CertificationRequest;Lorg/bouncycastle/est/ESTAuth;)Lorg/bouncycastle/est/EnrollmentResponse;
    ...
    invoke-virtual {v3, p2}, Lorg/bouncycastle/est/ESTRequestBuilder;->withData([B)Lorg/bouncycastle/est/ESTRequestBuilder;
    ...
    invoke-virtual {v2, v3, v4}, Lorg/bouncycastle/est/ESTRequestBuilder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lorg/bouncycastle/est/ESTRequestBuilder;
    ...
    invoke-virtual {v2, v3, p2}, Lorg/bouncycastle/est/ESTRequestBuilder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lorg/bouncycastle/est/ESTRequestBuilder;

    const-string p2, "Content-Transfer-Encoding"

    const-string v0, "base64"

    invoke-virtual {v2, p2, v0}, Lorg/bouncycastle/est/ESTRequestBuilder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lorg/bouncycastle/est/ESTRequestBuilder;

    if-eqz p3, :cond_1

    invoke-interface {p3, v2}, Lorg/bouncycastle/est/ESTAuth;->applyAuth(Lorg/bouncycastle/est/ESTRequestBuilder;)V
